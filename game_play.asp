...
<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="750" height="500" align="absmiddle">
                      <param name="movie" value="<%=rs("pf_uploadfile")%>">
                      <param name="quality" value="high">
                      <embed src="<%=rs("pf_uploadfile")%>" width="740" height="500" align="absmiddle" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash"></embed>
                    </object></td>
                  </tr>
                </table>
                </div>
