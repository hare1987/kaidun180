...
<div class="crumbs">
                  <div class="inner">
                     <span class="current">当前位置：<a href="index.asp">首 页</a>&nbsp;&gt;松江九亭校</span>
                     <ul>
                        <li class="style6">松江九亭校</li>
...
<%
				  ...
				  rs.open "select * from  pf_sc where sc_num=8",conn,1,1
				  %>
                      ...
                      <tr>
                        ...
                        <td width="578"><table width="94%" height="236" border="0" align="center">
                            <tr>
                              ...
                              <td width="55%" height="40"><a href="yy.asp?school=长宁校区"><img src="images/yy.png" alt="" width="140" height="50" border="0"></a></td>
                            </tr>
                            <tr>
