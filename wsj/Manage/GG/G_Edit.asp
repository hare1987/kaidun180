...
<%
	...
	Response.Write "<script language='javascript'>alert('参数错误!');document.location.href('G_Manage.asp');</script>"
	Response.End()
	end if
if Request("Action")=1 then
	...
	rs.Close
	Set rs=nothing
	Response.Write "<script language='javascript'>alert('公告修改成功!');document.location.href('G_Manage.asp');</script>"
	Response.End()
else
%>
...
<form id="form1" name="form1" method="post" action="?Action=1&id=<%=Request("id")%>">
  <table width="100%" border="0">
    <tr>
      <td height="25" colspan="2" bgcolor="#3385D1" class="bt2">　修改公告</td>
    </tr>
    <tr>
      <td width="69" align="right" valign="middle" bgcolor="#efefef" class="font1">标　　题：</td>
