...
<table width="100%" border="0">
  <tr>
    <td height="25" colspan="4" bgcolor="#3385D1" class="font2 STYLE1"><table width="100%" border="0" cellpadding="0" cellspacing="０">
      <tr>
        <td width="19%">　<span class="bt2">管理栏目新闻</span></td>
        <td width="81%" align="center">&nbsp;</td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td width="48%" align="center" valign="middle" bgcolor="#efefef" class="font1">标题</td>
    <td width="19%" align="center" valign="middle" bgcolor="#efefef" class="font1">发布时间</td>
...
<%
if Request("type_id")="error" or Request("type_id")="" then
	Response.Write "<script language='javascript'>alert('请选择栏目！');history.go(-1);</script>"
	Response.End()
end if
sql = "select * from news where type_id="&Request("type_id")&" order by id desc"
