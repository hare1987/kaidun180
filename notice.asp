...
<div class="crumbs">
 ...
 <div class="box">
	...
	<table width="97%"  border="0" align="left" cellpadding="0" cellspacing="0">
		...
		rs.open "select * from pf_news where pf_news_category ='凯顿通知' order by pf_news_date desc",conn,1,1
	...
	%>
                                <td height="20"><div align="left"><a href='noticeinfo.asp?id=<%=rs("id")%>'><%=replace(trim(rs("pf_news_name")),"<br>","")%></a>&nbsp;&nbsp;&nbsp;
                                        <%if  Datediff("d",rs("pf_news_date"),formatdatetime(now(),2)) <  7   then%>
