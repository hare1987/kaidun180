...
If request.Form("submit") = "确认修改" Then
    ...
    sql = "select * from pf_game where id = "&request.QueryString("id")&""
    ...
    Call close_rs
		...
		rsop("pf_op_sources") = "修改游戏:"& request.Form("pf_link_name")  &"信息"
		rsop.update
		rsop.close
		set rsop = nothing
	
    Call close_conn
    Call infohref("修改成功！", "pf_game.asp")
End If
%>
