...
If request.Form("submit") = "确认修改" Then
   ...
   ' End If
    ...
    Call close_rs
		...
		rsop("pf_op_sources") = "修改联系方式"
		rsop.update
		rsop.close
		set rsop = nothing
	
    Call close_conn
    Call infohref("修改成功！", "pf_contact.asp?id=1")
End If
%>
	...
	%>
				<form name="pcfinal" method="post">
					<tr>
					  ...
					  <td><textarea name="content2" style="display:none"><%=rs("z14")%></textarea>
