...
If request.Form("submit") = "删除选中" Then
    ...
    End If
    sql = "delete from pf_buy where id in ("&Request("id")&")"
    conn.Execute ( sql )
	...
	Call close_conn
    Call infohref("成功删除选中的信息！", "pf_gf_order.asp")
End If
%>
...
<div id="content">
	...
	<div id="right">
		<div class="right_title">
			<h1>在线预约&nbsp;&nbsp;&nbsp;<span class="right_body"><span class="style3"><a href="doexcel.asp" target="_blank"><font color="#FF0000">导出<span class="style2">excel</span>数据</font></a></span></span></h1>
			...
			<table>
				<form method="post">
					<tr>
						...
						<th width="124">活动选项</th>
					</tr>
					<%
Set rs = server.CreateObject("adodb.recordset")
sql = "select * from pf_buy order by regtime desc"
