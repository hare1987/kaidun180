...
If request.Form("submit") = "确认修改" Then
   ...
   ' End If
    ...
    Call close_rs
		...
		rsop("pf_op_sources") = "短期课程--Sing & Chant修改"
		rsop.update
		rsop.close
		set rsop = nothing
	
    Call close_conn
    Call infohref("修改成功！", "pf_c2.asp?id=1")
End If
%>
	...
	%>
				<form name="pcfinal" method="post">
					<tr>
					  ...
					  <td><textarea name="content2" style="display:none"><%=rs("z17")%></textarea>
