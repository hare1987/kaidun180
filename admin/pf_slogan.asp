...
If request.Form("submit") = "确认修改" Then
   ...
   ' End If
    ...
    rs("slogan") = request.Form("content2")
    rs.update
    Call close_rs
		...
		rsop("pf_op_sources") = "跑马灯修改成功"
		rsop.update
		rsop.close
		set rsop = nothing
	
    Call close_conn
    Call infohref("修改成功！", "pf_slogan.asp?id=1")
End If
%>
...
<div id="content">
	...
	%>
				<form name="pcfinal" method="post">
					<tr>
                      <td width="80" align="center">跑马灯内容：</td>
					  <td><textarea name="content2" style="width:500px; height:20px;"><%=rs("slogan")%></textarea>
                 </td>
				  </tr>
					<tr>
