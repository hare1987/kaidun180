...
<div class="crumbs">
                  <div class="inner">
                     <span class="current">当前位置：<a href="index.asp">首 页</a>&nbsp;&gt;黄浦书城校</span>
                     <ul>
                        <li class="style6">黄浦书城校</li>
                      ...
                      <tr>
                        ...
                        <td width="578"><table width="94%" height="236" border="0" align="center">
                            <tr>
                              ...
                              <td width="55%" height="40"><a href="yy.asp?school=黄浦书城校"><img src="images/yy.png" width="140" height="50" border="0"></a></td>
                            </tr>
                            <tr>
