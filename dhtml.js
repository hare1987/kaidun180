...
mtDropDown.backgroundColor = "#AFAFAF"; 
mtDropDown.backgroundPng = ""; 
mtDropDown.hideDelay = 400; 
...
function mtDropDown(oActuator, iDirection, iLeft, iTop, iReferencePoint, parentMenuSet) {
	...
	function addMenu(oMenuItem) {
		...
		if (childMenuSet == null) childMenuSet = new mtDropDownSet(mtDropDown.direction.right, 0, 2, mtDropDown.reference.topRight);
	...
	function toString() {
		...
		aHtml.join('') + 
		'</table>' + 
		'<div class="shadowBottom" z-index="100000"><img src="' + mtDropDown.spacerGif + '" width="1" height="1"></div>' + 
