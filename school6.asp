...
<div class="crumbs">
                  <div class="inner">
                     <span class="current">当前位置：<a href="index.asp">首 页</a>&nbsp;&gt;<a href="school.asp">校区介绍</a>&nbsp;&gt;长宁虹桥校</span>
                     <ul>
...
<div class="contents">
			<div class="content">
				<div class="title">长宁虹桥校<span style="float:right;"><a href="yy.asp?school=长宁虹桥校"><img src="images/yy.png" border="0"></a></span></div>
                 <%
				  set rs=server.CreateObject("adodb.recordset")
				  rs.open "select * from pf_sc where sc_num=7",conn,1,1
				  %>
